...
{ iconName: 'icofont-envelope', text: ' info@shopease.com', },]
...
const tweetList = [{
    iconName: 'icofont-twitter', desc:
        ...
        'Aminur islam @SHOPEASE Greetings! #HTML_Template Grab your item, 50 % Big Sale Offer!!'

    ,
}, {
    iconName: 'icofont-twitter',
    desc: 'Somrat islam @SHOPEASE Hey! #HTML_Template Grab your item, 50 % Big Sale Offer!!'
            ...
            <div className='footer-bottom'>
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2025 <Link to="/">SHOPEASE</Link> — Designed by{' '}<a href='/' target='_blank'>Tajbik Sifat</a>. All rights reserved.</p>
